...
type MoneyTransactionClient interface {
	MakeTransaction(ctx context.Context, in *TranscationRequest, opts ...grpc.CallOption) (*TranscationResponse, error)
}
...
func (c *moneyTransactionClient) MakeTransaction(ctx context.Context, in *TranscationRequest, opts ...grpc.CallOption) (*TranscationResponse, error) {
	out := new(TranscationResponse)
...
type MoneyTransactionServer interface {
	MakeTransaction(context.Context, *TranscationRequest) (*TranscationResponse, error)
...
func (UnimplementedMoneyTransactionServer) MakeTransaction(context.Context, *TranscationRequest) (*TranscationResponse, error) {
...
func _MoneyTransaction_MakeTransaction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MoneyTransactionServer).MakeTransaction(ctx, req.(*TranscationRequest))
	}
